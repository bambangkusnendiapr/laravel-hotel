...
<head>
    ...
    <meta name=description content="Cukup dengan merogoh kocek mulai dari Rp350.000, Anda sudah bisa mendapat penginapan dengan kualitas mantap tapi harga bersahabat. Hotel ini cocok bagi wisatawan yang ingin jalan-jalan.">
    ...
    <meta property="og:description" content="Cukup dengan merogoh kocek mulai dari Rp350.000, Anda sudah bisa mendapat penginapan dengan kualitas mantap tapi harga bersahabat. Hotel ini cocok bagi wisatawan yang ingin jalan-jalan.">
                                    ...
                                    <ul id="navigation">
                                        ...
                                        <li><a href="#">Fasilitas</a>
                                            <ul class="submenu">
                                                ...
                                                <li><a href="{{ url('/ruangMakan')}}">Ruang Makan</a></li>
                                            </ul>
                                        </li>
